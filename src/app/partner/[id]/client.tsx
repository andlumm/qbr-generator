...
import { Partner, PartnerMetrics } from '@/lib/db/schema'
import { CalculatedQBRDashboard } from '@/components/dashboard/CalculatedQBRDashboard'
import { 
...
interface PartnerQBRClientProps {
  partner: Partner
  metrics: any
  allPartners: Partner[]
...
export function PartnerQBRClient({ partner, metrics, allPartners, allPartnerMetrics }: PartnerQBRClientProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 text-slate-900">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Calculated QBR Dashboard with Audit Trails */}
        <CalculatedQBRDashboard 
          partner={partner} 
          metrics={metrics} 
